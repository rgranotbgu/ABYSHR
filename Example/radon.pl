...
$radius=5000; # radius of the Radon transform [meters]
$res=150; # resolution of the grid
$num_tracks=1; #number of track files that exist in this folder: track1, track2 ... track$num_tracks
#***************************************
...
system("echo Gridding multibeam");
